...
salarioBase = salario - aliquota;

if( salarioBase <= 1903.98){
  valorImpostoRenda = 0;
}else if( salarioBase >= 1903.99 && salarioBase <= 2826.65){
  valorImpostoRenda = (salarioBase * 0.075) - 142.80;
}else if( salarioBase >= 2826.66 && salarioBase <= 3751.05){
  valorImpostoRenda = (salarioBase * 0.15) - 354.80;
}else if( salarioBase >= 3751.06 && salarioBase <= 4664.68){
  valorImpostoRenda = (salarioBase * 0.225) - 636.13;  
}else{
  valorImpostoRenda = (salarioBase * 0.275) - 869.36;
}

salarioLiquido = salarioBase - valorImpostoRenda;

console.log('O valor é ' + salarioLiquido);
